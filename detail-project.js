...
const projects = {
  warkod: {
    title: "Warkod",
    previewText:
      "Digital business platform for modern website and mobile app solutions",
    overview: [
  ...
  thriftshop: {
    title: "Thriftshop",
    previewText:
      "Minimal thrift fashion e-commerce website with clean shopping experience",
    overview: [
  ...
  psychocare: {
    title: "Psychocare",
    previewText:
      "Mental health consultation platform with supportive and accessible interface",
    overview: [
  ...
  kitaptn: {
    title: "KitaPTN",
    previewText:
      "Educational platform for PTN preparation with learning materials and mock exams",
    overview: [
  ...
  perpustakaan: {
    title: "Perpustakaan",
    previewText:
      "Modern library management system with QR scanning and borrowing automation",
    overview: [
  ...
  sporton: {
    title: "SportOn",
    previewText:
      "Modern sports e-commerce platform with integrated shopping cart and real-time transaction management",
    overview: [
...
const isDetailPage = document.querySelector("#project-detail");
...
if (isDetailPage) {
  if (projectId && projects[projectId]) {
    ...
    document.querySelector("header p").textContent = project.previewText;

    // Gambar
    document.querySelector("#project-detail img").src = project.image;
    document.querySelector("#project-detail img").alt =
      project.title + " Image";
